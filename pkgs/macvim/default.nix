{ lib, stdenv, callPackage, vimUtils, buildEnv, makeWrapper, withAppBundle ? (import ../withAppBundle {}) }:
    ...
    configure = let
      ...
      in buildEnv {
        ...
        postBuild = ''
          ...
          substituteInPlace $out/Applications/MacVim.app/Contents/MacOS/Vim \
            --replace $out/Applications/MacVim.app/Contents/MacOS/.Vim-wrapped "${withAppBundle "MacVim" (app: "${app}/Contents/MacOS/.Vim-wrapped")}" \
